...
public class TTetromino implements Tetromino
{
  /******************************************************************/
  //  instance variables
  ...
  public TTetromino( int r, int c )
  {
    ...
    for( int i = 0; i < 4; i++ )
    {
      ...
      tiles.get( i ).setFillColor( Specs.T_COLOR );
      tiles.get( i ).setFrameColor( Color.BLACK );
      tiles.get( i ).setSize( Specs.TILE_SIZE, Specs.TILE_SIZE );
    }
    
    config = new Vector< Configuration >( );
    config.add( new Configuration( 0, 0, 1, 0, 2, 0, 1, 1 ) );
    config.add( new Configuration( 2, 0, 2, 1, 2, 2, 1, 1 ) );
    config.add( new Configuration( 0, 2, 1, 2, 2, 2, 1, 1 ) );
    config.add( new Configuration( 0, 0, 0, 1, 0, 2, 1, 1 ) );
  ...
  /*===================================================================/
   /**
   * move right: make the shape move right 
   */ 
  ...
  /*===================================================================/
   /**
   * move left: make the shape move left
   */ 
  ...
  /*===================================================================/
   /**
   *   get the minimum col index for this shape
   */ 
