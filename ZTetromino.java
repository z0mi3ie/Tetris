...
public class ZTetromino implements Tetromino
{
  /******************************************************************/
  //  instance variables
  ...
  public ZTetromino( int r, int c )
  {
    ...
    for( int i = 0; i < 4; i++ )
    {
      ...
      tiles.get( i ).setFillColor( Specs.Z_COLOR );
      tiles.get( i ).setFrameColor( Color.BLACK );
      tiles.get( i ).setSize( Specs.TILE_SIZE, Specs.TILE_SIZE );
    }
    
    config = new Vector< Configuration >( );
    config.add( new Configuration( 0, 0, 1, 0, 1, 1, 2, 1 ) );
    config.add( new Configuration( 1, 0, 1, 1, 0, 1, 0, 2 ) );
    config.add( new Configuration( 0, 0, 1, 0, 1, 1, 2, 1 ) );
    config.add( new Configuration( 1, 0, 1, 1, 0, 1, 0, 2 ) );
  ...
  {     
    new Frame( );
    ZTetromino test = new ZTetromino(5, 5);
